...
{
    public partial class TambahPaketMakeUp : Form
    {
        public TambahPaketMakeUp()
        {
            InitializeComponent();
            string query = "select top 1 Id_pkt_makeup from Jasa_Makeup order by Id_pkt_makeup desc";
            txtID.Text = autogenerateID("MU", query);
        }
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand insert = new SqlCommand("sp_InsertJasaMakeup", connection);
                insert.CommandType = CommandType.StoredProcedure;

                insert.Parameters.AddWithValue("Id_pkt_makeup", txtID.Text);

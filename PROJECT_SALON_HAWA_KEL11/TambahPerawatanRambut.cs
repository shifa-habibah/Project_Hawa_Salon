...
{
    public partial class TambahPerawatanRambut : Form
    {
        public TambahPerawatanRambut()
        {
            InitializeComponent();
            string query = "select top 1 Id_prwt_rambut from Perawatan_Rambut order by Id_prwt_rambut desc";
            txtID.Text = autogenerateID("PR", query);
        }
        SqlCommand sqlCmd;
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand insert = new SqlCommand("sp_InsertPrwtRambut", connection);
                insert.CommandType = CommandType.StoredProcedure;

                insert.Parameters.AddWithValue("Id_prwt_rambut", txtID.Text);
